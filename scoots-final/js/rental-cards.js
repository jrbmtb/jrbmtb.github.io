...
fetch(requestURL)
  ...
  .then(function (jsonObject) {
    ...
    for (let i = 0; i < rentals.length; i++ ) {
      ...
      let p1 = document.createElement('h4'); //Max persons
      let hr = document.createElement('hr'); //Divion
      ...
      let b = document.createElement('a'); //Rent button
      ...
      card.appendChild(b); //Rent button
